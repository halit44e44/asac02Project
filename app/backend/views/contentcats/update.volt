...
<form id="contentcatForm" method="post">
    <input type="hidden" name="id" value="{{ contentcats.id }}" />
        ...
        <div class="card-body">
            <div class="form-group row">
                <div class="col-lg-6">
                    ...
                    <input type="text" id="name" name="name" value="{{ contentcats.name }}" class="form-control" placeholder="Kategori adını yazınız" autofocus="" />
                </div>
                <div class="col-lg-6">
            ...
            <div class="form-group row">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <label>İçerik:</label>
                    <textarea type="text" rows="2" class="form-control" id="content" name="content">{{ contentcats.content }}</textarea>
                </div>
            </div>
    ...
    <div class="card card-custom gutter-b seoCard" data-card="true">
        ...
        <div class="card-body">
            ...
            <div class="seo_preview">
                ...
                <h1 class="slugTitle">{{ contentcats.seo_title }}</h1>
                <span>{{ site_url }}/</span><span><strong class="slugText">{{ contentcats.sef }}</strong></span>
                <p class="slugDesc">{{ contentcats.description }}</p>
            </div>
            ...
            <div class="form-group row">
                <div class="col-lg-6">
                    ...
                    <div class="input-group">
                        <input type="text" class="form-control" name="seo_title" value="{% if contentcats is defined %}{{ contentcats.seo_title }}{% endif %}" id="seotitle" placeholder="Arama motorlarında görünecek başlık" />
                    </div>
                </div>
                <div class="col-lg-6">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control slugurl" name="sef" value="{{ contentcats.sef }}" />
                    </div>
                </div>
            </div>
            ...
            <div class="form-group row">
                <div class="col-lg-12">
                    ...
                    <div class="input-group">
                        <input id="etiket" class="form-control tagify" name='keyword' placeholder='etiketleri yazınız...' value="{{ contentcats.keyword }}" />
                    </div>
                </div>
            </div>
            ...
            <div class="form-group row">
                <div class="col-lg-12">
                    ...
                    <div class="input-group">
                        <textarea type="text" rows="2" class="form-control" id="description" maxlength="150" name="description">{{ contentcats.description }}</textarea>
                    </div>
                </div>
            </div>
        </div>
...
<div class="card card-custom gutter-b photoCard" data-card="true">
    ...
    <div class="card-body">
        <form class="dropzone dropzone-default dropzone-primary photoupload">
            <input type="hidden" class="lastid" name="id" value="{% if contentcats is defined %}{{ contentcats.id }}{% endif %}" />
                ...
                <div class="d-flex">
                    <div class="flex-shrink-0 mr-7">
                        <div class="symbol symbol-50 symbol-lg-120">
                            <img src="{{ url('media/contentcats/' ~ image.meta_value) }}" style="object-fit: cover;" />
                        </div>
                    </div>
                    <div class="flex-grow-1">
                        <form id="form_{{ image.id }}">
                            <input type="hidden" class="lastid" name="id" value="{{ image.id }}" />
                            <input type="hidden" name="table" value="contentcats" />
                            ...
                            <div class="d-flex align-items-center flex-wrap justify-content-between row">
                                ...
                                <div class="col-md-6 text-right">
                                    <button type="button" onclick="removeImage(this)" data-id="{{ image.id }}" data-table="contentcats" class="btn btn-light-danger mr-2">Kaldır</button>
...
<script>
    $(document).ready(function () {
        ...
        const categoryPicker = $('#catPicker').comboTree({
            ...
            cascadeSelect: true,
            collapse: false,
            selected: [{% if contentcats.top_id is defined %}{{contentcats.top_id}}{% endif %}]
        });
        ...
        $('#contentcatForm').validate({
            ...
            submitHandler: function () {
                ...
                $.ajax({
                    type: 'post',
                    url: '{{ url("backend/contentcats/update/") }}',
                    data: data,
