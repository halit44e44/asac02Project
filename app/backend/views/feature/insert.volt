            ...
            <div class="form-group row">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <input class="form-control form-control-solid form-control-lg pl-4" type="text" id="catPicker" placeholder="Yeni özellik" autocomplete="off"/>
...
<div class="card card-custom gutter-b photoCard dn" data-card="true">
    ...
    <div class="card-footer">
        <div class="row">
            <div class="col-lg-12 text-right">
                <a href="{{ url('backend/feature') }}" class="btn btn-primary">İşlemleri Tamamla</a>
            </div>
        </div>
    </div>
</div>
        ...
        $('#featureForm').validate({
            ...
            submitHandler: function () {
                ...
                if (user === "3") {
                    ...
                    $.ajax({
                        type: 'post',
                        url: '{{ url("backend/feature/insert/") }}',
                        data: data,
