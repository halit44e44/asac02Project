<form id="groupForm" method="post">
    ...
    <div class="card card-custom gutter-b example example-compact">
        <div class="card-header">
            <h3 class="card-title">Yeni Kullanıcı Grubu Ekle</h3>
        </div>
        ...
        <div class="card-body">
            ...
            <div class="form-group row">
                <div class="col-lg-12">
                    ...
                    <input type="text" id="name" name="name" maxlength="100" minlength="3" class="form-control" placeholder="Kullanıcı grubunu yazınız" />
                </div>
            </div>
    ...
    $(document).ready(function () {
        ...
        $('#groupForm').validate({
            ...
            submitHandler: function () {
                ...
                $.ajax({
                    type: 'post',
                    url: '{{ url("backend/usergroup/insert/") }}',
                    data: data,
