<form id="vouchersForm" class="form" method="post">
    <div class="card card-custom">

        <div class="card-header">
            <h3 class="card-title font-weight-bolder text-dark font-size-h6 mb-0">Hediye Çeki Oluştur</h3>
        </div>
        ...
        <div class="card-body">
            ...
            <div class="form-group row">
                <div class="col-lg-12">
                    ...
                    <div class="input-group">
                        <input type="text" id="voucher_code" name="voucher_code" class="form-control form-control-solid" />
            ...
            <div class="form-group row">
             ...
             <div class="form-group row">
                <div class="col-lg-6">
                    ...
                    <div class="input-group">
                        <input type="number" id="maximum_usage" name="maximum_usage" min="0" class="form-control form-control-solid" />
                    </div>
                </div>
                ...
                <div class="col-lg-6">
                    ...
                    <div class="input-group">
                        <input type="number" id="limit_of_per_person" name="limit_of_per_person" min="0" class="form-control form-control-solid" />
                    </div>
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="input-group">
                        <input type="text" id="end_date" name="end_date" class="form-control form-control-solid" value="{{ end_date }}" />
                    </div>
                </div>
            </div>
            ...
            <div class="form-group row">
                <div class="col-lg-6">
                    ...
                    <div class="input-group">
                        <select class="form-control select form-control-solid" name="discount_type">
                            <option value="1">Sabit Fiyat</option>
                ...
                <div class="col-lg-6">
                    <label>İndirim: </label>
                    <div class="input-group">
                        <input type="text" id="discount" name="discount" class="form-control form-control-solid" />
                    </div>
                </div>
            </div>
            ...
            <div class="form-group row">
                <div class="col-lg-6">
                    ...
                    <div class="input-group">
                        <select class="form-control select form-control-solid" id="kt_select2_4" name="voucher">
                            <option value="1">Tüm Kategori ve Markalar</option>
                            <option value="2">Belirli Ürünlere Özel</option>
                            <option value="3">Belirli Kategorilere Özel</option>
                            <option value="4">Belirli Markalara Özel</option>
                            <option value="5">Belirli Üyelere Özel</option>
                            <option value="6">Belirli Üye Grublarına Özel</option>
                        </select>
                    </div>
                </div>

                <div class="col-lg-6 mt-8" id="select" style="display: none;">
                   <div class="radio-inline">
                       <div id="usergroups" style="display: none;">
                            <select class="selectpicker  form-control-solid" data-live-search="true" name="usergroups[]" multiple="multiple" >
                       ...
                       <div id="brand" style="display: none;">
                           <select class="selectpicker" data-live-search="true" name="brand[]" multiple="multiple">
                               <option value="0">Tamamı</option>
                               {% if brand is defined %}
                                   {% for brand in brand %}
    ...
    $(document).ready(function () {
        ...
        $('#vouchersForm').validate({
            ...
            submitHandler: function () {
                ...
                $.ajax({
                    type: 'post',
                    url: '{{ url("backend/vouchers/insert/") }}',
                    data: data,
