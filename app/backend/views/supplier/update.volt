        ...
        <div class="card-body">
            ...
            <div class="form-group row">
                <div class="col-lg-12">
                    ...
                    <input type="text" id="name" name="name" value="{{ supplier.name }}" maxlength="100" minlength="3" class="form-control" placeholder="Tedarikçi yazınız" />
                </div>
            </div>
    ...
    $(document).ready(function () {
        ...
        $('#supplierForm').validate({
            ...
            submitHandler: function () {
                ...
                $.ajax({
                    type: 'post',
                    url: '{{ url("backend/supplier/update") }}',
                    data: data,
