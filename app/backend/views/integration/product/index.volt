<div class="card card-custom">
    <div class="card-header flex-wrap border-0 pt-6 pb-0">
        <div class="card-title">
            <h3 class="card-label list-title">Entegrasyon Ürün Listesi
                <span class="d-block text-muted pt-2 font-size-sm">Entegrelerde bulunan ürünler ve daha fazlası.</span>
            </h3>
        </div>
    ...
    <div class="card-body">
        ...
        id="data_product" data-table="product"></div>
