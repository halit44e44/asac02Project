<style>
    .card-toolbar {float: left; position: absolute; right: 20px; top: 30px;}
</style>
                ...
                <div class="card card-custom card-stretch">
                    ...
                    <div class="card-body pt-4">
                        ...
                        <div class="navi navi-bold navi-hover navi-active navi-link-rounded">
                            ...
                            <div class="navi-item mb-2">
                                <a href="{{ url('backend/user/profile/personel/' ~ user.id) }}" class="navi-link py-4 active">
                                        <span class="navi-icon mr-2">
                                            <span class="svg-icon">
                    ...
                    <form class="form" id="personalForm">
                        ...
                        <div class="card-header py-3">
                            <div class="card-title align-items-start flex-column mb-5">
                                <div class="pt-5">
                                    ...
                                    <span class="text-muted font-weight-bold font-size-sm mt-1">Kullanıcı bilgilierini düzenle</span>
                                </div>
                            </div>
                            <div class="card-toolbar">
                                <button type="submit" class="btn btn-success mr-2">Değişiklikleri Kaydet</button>
                                <a href="{{ url('backend/user/') }}" class="btn btn-secondary">Vazgeç</a>
                            </div>
                        </div>
                        <!--end::Header-->
                        ...
                        <div class="card-body">
                            <div class="form-group row">
                                <label class="col-xl-3 col-lg-3 col-form-label text-right">Adı Soyadı</label>
                                <div class="col-lg-9 col-xl-6">
                                    <input class="form-control form-control-lg form-control-solid" type="text" name="name" value="{% if user is defined %}{{ user.name }}{% endif %}" />
                                </div>
                            </div>

                            <div class="form-group row">
                                <label class="col-xl-3 col-lg-3 col-form-label text-right">Email Adresi</label>
                                <div class="col-lg-9 col-xl-6">
                                    <input class="form-control form-control-lg form-control-solid" type="email" name="email" value="{% if user is defined %}{{ user.email }}{% endif %}" />
                                </div>
                            </div>

                            <div class="form-group row">
                                <label class="col-xl-3 col-lg-3 col-form-label text-right">Telefon Numarası</label>
                                <div class="col-lg-9 col-xl-6">
                                    <input class="form-control form-control-lg form-control-solid" type="text" name="phone" value="{% if user is defined %}{{ user.phone }}{% endif %}" />
                                </div>
                            </div>

                            <div class="form-group row">
                                <label class="col-xl-3 col-lg-3 col-form-label text-right">TC Kimlik Numarası</label>
                                <div class="col-lg-9 col-xl-6">
                                    <input class="form-control form-control-lg form-control-solid" type="text" name="id_no" value="{% if user is defined %}{{ user.id_no }}{% endif %}" />
                                </div>
                            </div>

                            <div class="form-group row">
                                <label class="col-xl-3 col-lg-3 col-form-label text-right">Cinsiyet</label>
                                <div class="col-lg-9 col-xl-6">
                                    <select name="gender" class="form-control form-control-lg form-control-solid">
                                        <option value="1" {% if user.gender is 1 %}selected{% endif %}>Erkek</option>
                                        <option value="2" {% if user.gender is 2 %}selected{% endif %}>Kadın</option>
                                        <option value="3" {% if user.gender is 3 %}selected{% endif %}>Belirtmedi</option>
                                    </select>
                                </div>
                            </div>

                            <div class="form-group row">
                                <label class="col-xl-3 col-lg-3 col-form-label text-right">Doğum Tarihi</label>
                                <div class="col-lg-9 col-xl-6">
                                    <input class="form-control form-control-lg form-control-solid" id="birthDate" type="text" readonly name="birth_date" value="{% if birth_date is defined %}{{ birth_date }}{% endif %}" />
                                </div>
                            </div>

                            <div class="form-group row">
                                <label class="col-xl-3 col-lg-3 col-form-label text-right">Üyelik Grubu</label>
                                <div class="col-lg-9 col-xl-6">
                                    <select name="group_id" class="form-control form-control-lg form-control-solid">
                                        {% if usergroup is defined %}
                                            {% for group in usergroup %}
                                                <option value="{{ group.id }}" {% if user.group_id is group.id %}selected{% endif %}>{{ group.name }}</option>
                                            {% endfor %}
                                        {% endif %}
                                    </select>
                                </div>
    ...
    $(document).ready(function () {
        ...
        $('#personalForm').validate({
            ...
            messages: {
                ...
                birth_date: "Lütfen bu alanı doldurunuz!"
            },
            submitHandler: function () {
                $('.alert').addClass('dn');
                const data = $('#personalForm').serialize();
                $.ajax({
                    type: 'post',
