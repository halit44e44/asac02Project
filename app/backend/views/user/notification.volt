                ...
                <div class="card card-custom card-stretch">
                    ...
                    <div class="card-body pt-4">
                        ...
                        <div class="navi navi-bold navi-hover navi-active navi-link-rounded">
                            ...
                            <div class="navi-item mb-2">
                                <a href="{{ url('backend/user/profile/notification/' ~ user.id) }}" class="navi-link py-4 active">
                                <span class="navi-icon mr-2">
                                    <span class="svg-icon">
                    ...
                    <form class="form" id="notifyForm">
                        ...
                        <div class="card-header py-3">
                            <div class="card-title align-items-start flex-column mb-5">
                                <div class="pt-5">
                                    <h3 class="card-label font-weight-bolder text-dark">Bildirim Ayarları</h3>
                                    <span class="text-muted font-weight-bold font-size-sm mt-1">Kullanıcı onayı olmadan değişiklik yapmayınız!</span>
                                </div>
                            </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                <label class="col-xl-3 col-lg-3 col-form-label text-right">Email Bildirimleri</label>
                                <div class="col-lg-9 col-xl-6">
                                    <div class="checkbox-list">

                                        <label class="checkbox">
                                            <input type="checkbox" name="email_news" {% if notify is defined %}{% if notify.email_news is 1 %}checked{% endif %}{% endif %} />
                                            <span></span>Kampanya / Haber / Duyuru
                                        </label>

                                        <label class="checkbox">
                                            <input type="checkbox" name="email_order" {% if notify is defined %}{% if notify.email_order is 1 %}checked{% endif %}{% endif %} />
                                            <span></span>Sipariş Durumları
                                        </label>
                            ...
                            <div class="form-group row">
                                <label class="col-xl-3 col-lg-3 col-form-label text-right">SMS Bildirimleri</label>
                                <div class="col-lg-9 col-xl-6">
                                    <div class="checkbox-list">

                                        <label class="checkbox checkbox-primary">
                                            <input type="checkbox" name="sms_news" {% if notify is defined %}{% if notify.sms_news is 1 %}checked{% endif %}{% endif %} />
                                            <span></span>Kampanya / Haber / Duyuru
                                        </label>

                                        <label class="checkbox checkbox-primary">
                                            <input type="checkbox" name="sms_order" {% if notify is defined %}{% if notify.sms_order is 1 %}checked{% endif %}{% endif %} />
                                            <span></span>Sipariş Durumları
                                        </label>
    ...
    $(document).ready(function () {
        ...
        $('#notifyForm').validate({
            submitHandler: function () {
                $('.alert').addClass('dn');
                const data = $('#notifyForm').serialize();
                $.ajax({
                    type: 'post',
                    ...
                    success: function (response) {
                        if (response === 'ok') {
                            ...
                            $('.alert').removeClass('dn').removeClass('alert-secondary').addClass('alert-danger').html('Yeni belirlediğiniz şifreler aynı değil!');
                        } else if (response === 'nopass') {
                            $('.alert').removeClass('dn').removeClass('alert-secondary').addClass('alert-danger').html('Eski şifreniz hatalı! Lütfen kontrol ederek tekrar deneyiniz.');
                        } else {
