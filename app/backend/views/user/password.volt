                ...
                <div class="card card-custom card-stretch">
                    ...
                    <div class="card-body pt-4">
                        ...
                        <div class="navi navi-bold navi-hover navi-active navi-link-rounded">
                            ...
                            <div class="navi-item mb-2">
                                <a href="{{ url('backend/user/profile/password/' ~ user.id) }}" class="navi-link py-4 active">
                                        <span class="navi-icon mr-2">
                                            <span class="svg-icon">
                    ...
                    <form id="passForm">
                        ...
                        <div class="card-header py-3">
                            <div class="card-title align-items-start flex-column mb-5">
                                <div class="pt-5">
                                    <h3 class="card-label font-weight-bolder text-dark">Şifre Güncelle</h3>
                                    <span class="text-muted font-weight-bold font-size-sm mt-1">Kullanıcı şifrenizi güncelleyin.</span>
                                </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9 col-xl-6">
                                    <input type="password" id="password1" class="form-control form-control-lg form-control-solid" name="password1" value="" />
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-xl-3 col-lg-3 col-form-label text-alert">Yeni Şifreyi Doğrula</label>
                                <div class="col-lg-9 col-xl-6">
                                    <input type="password" id="password2" class="form-control form-control-lg form-control-solid" name="password2" value="" />
                                </div>
                            </div>
                        </div>
                    </form>
...
<script>
    $(document).ready(function () {
        ...
        $('#passForm').validate({
            ...
            messages: {
                password: "Mevcut şifreyi yazınız!",
                password1: "Yeni şifre belirleyiniz!",
                password2: "Yeni şifreyi tekrar yazınız!"
            },
            submitHandler: function () {
                $('.alert').addClass('dn');
                const data = $('#passForm').serialize();
                $.ajax({
                    type: 'post',
