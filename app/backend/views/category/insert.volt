            ...
            <div class="form-group row">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control slugurl" name="slugurl" />
                    </div>
                </div>
            </div>
...
<div class="card card-custom gutter-b photoCard dn" data-card="true">
    ...
    <div class="card-footer">
        <div class="row">
            <div class="col-lg-12 text-right">
                <a href="{{ url('backend/category') }}" class="btn btn-primary">İşlemleri Tamamla</a>
            </div>
        </div>
    </div>
</div>
        ...
        $('#catForm').validate({
            ...
            submitHandler: function () {
                ...
                if (user === "3") {
                    ...
                    $.ajax({
                        type: 'post',
                        url: '{{ url("backend/category/insert/") }}',
                        data: data,
